...
const Login = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            ? {email: formData.email, password: formData.password} : formData
    ...
    return (
        <section className="relative flex items-center justify-center min-h-screen bg-[#020319] bg-cover bg-center bg-no-repeat">
            <form

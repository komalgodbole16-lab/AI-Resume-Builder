  ...
  return (
    <div>
      ...
      <div className='flex items-center gap-2'>
        <label>
          {data.image ? (
            <img src={typeof data.image === 'string' ? data.image : data.image instanceof File ? URL.createObjectURL(data.image) : data.image} alt="user-image" className='w-16 h-16 rounded-full object-cover mt-5 ring ring-slate-300 hover:opacity-80' />
          ) : (

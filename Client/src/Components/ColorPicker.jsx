...
const ColorPicker = ({ selectedColor, onChange }) => {
  ...
  return (
    <div className='relative'>
      <button onClick={() => setIsopen(!isOpen)} className='flex items-center gap-1 text-sm text-purple-600 bg-linear-to-br from-purple-100 to-purple-50 ring-purple-300 hover:ring transition-all px-3 py-2 rounded-lg'>
